...
- **Custom domain:** TBD — see [DOCS/PHASE_1.md](../DOCS/PHASE_1.md) ticket P1-034 (candidates: `getvibe.app`, `vibe.cc`, `joinvibe.app`, `vibe.so`, `withvibe.com`)
...
- **Direct page links** (cleaner URLs ship in P1-008 URL polish):
